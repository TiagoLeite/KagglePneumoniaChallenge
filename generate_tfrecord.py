...
def create_tf_example(group, path):
    # print('PATH', path + group.filename + '.jpg')
    ...
    for index, row in group.object.iterrows():
        ...
        classes_text.append(row['Target'].encode('utf8'))
...
def main(_):
    ...
    path = os.path.join(os.getcwd(), 'data/images/train_jpg/')
    examples = pd.read_csv(FLAGS.csv_input)
    grouped = split(examples, 'patientId')
